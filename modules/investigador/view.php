...
class InvestigadorView extends View {
	...
	function agregar($investigadorcategoria_collection, $lineainvestigacion_collection, $sublineainvestigacion_collection, $grupoinvestigacion_collection, $universidad_collection, $universidadfacultad_collection, $universidadarea_collection) {
		...
		$gui_slt_grupoinvestigacion = file_get_contents("static/common/slt_grupoinvestigacion.html");
		$gui_slt_grupoinvestigacion = $this->render_regex('SLT_GRUPOINVESTIGACION', $gui_slt_grupoinvestigacion, $grupoinvestigacion_collection);
		...
		$render = str_replace('{slt_grupoinvestigacion}', $gui_slt_grupoinvestigacion, $render);
